...
var Webhook = /** @class */ (function (_super) {
     ...
     * @throws {TimeoutError}
     */
    Webhook.prototype.update = function (userId, body) {
     ...
     * @throws {TimeoutError}
     */
    Webhook.prototype.rawUpdate = function (userId, body) {
        return this.client.request({
            method: 'PUT',
            url: "/webhooks/".concat(userId),
            body: body,
        });
    };
    /**
     ...
     * @throws {TimeoutError}
     */
    Webhook.prototype.find = function (userId) {
     ...
     * @throws {TimeoutError}
     */
    Webhook.prototype.rawFind = function (userId) {
        return this.client.request({
            method: 'GET',
            url: "/webhooks/".concat(userId),
        });
     ...
     * @throws {TimeoutError}
     */
    Webhook.prototype.destroy = function (userId) {
        return this.rawDestroy(Utils.toId(userId)).then(function (body) {
            return Utils.deserializeResponseBody(body);
        });
    };
    /**
     ...
     * @throws {TimeoutError}
     */
    Webhook.prototype.rawDestroy = function (userId) {
        return this.client.request({
            method: 'DELETE',
            url: "/webhooks/".concat(userId),
        });
