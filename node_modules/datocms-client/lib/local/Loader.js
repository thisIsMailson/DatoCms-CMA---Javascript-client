...
var _generateClient = require("../utils/generateClient");
...
var Loader = /*#__PURE__*/function () {
  function Loader(clientOrClientArgs) {
    ...
    if ((0, _generateClient.isClient)(clientOrClientArgs)) {
      this.client = clientOrClientArgs;
    } else {
      this.client = _construct(_SiteClient["default"], _toConsumableArray(clientOrClientArgs));
  ...
  _createClass(Loader, [{
    ...
    value: function cacheKey() {
      return "datocms-loader-data-".concat(JSON.stringify({
    ...
    value: function load() {
      ...
      return Promise.all([this.client.get('/site', {
        ...
        _this2.entitiesRepo.destroyAllEntities();

        _this2.entitiesRepo.upsertEntities(site, items, uploads);
      });
    }
  }, {
    key: "watch",
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return Promise.all([_this3.client.get('/site', {
                            include: 'item_types,item_types.fields'
                          }), _this3.client.items.all({
                            version: itemVersion
                          }, {
                            deserializeResponse: false,
                            allPages: _this3.pageSize
                          }), _this3.client.uploads.all({}, {
                            deserializeResponse: false,
                            allPages: _this3.pageSize
                          })]);
                        ...
                        case 2:
                          ...
                          (_this3$entitiesRepo = _this3.entitiesRepo).upsertEntities.apply(_this3$entitiesRepo, _toConsumableArray(payloads));
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            ids = _ref5.ids;
                            _context2.next = 3;
                            return _this3.client.items.all({
                              'filter[ids]': ids.join(','),
                              version: itemVersion
                            }, {
                              deserializeResponse: false,
                          ...
                          case 3:
                            ...
                            _this3.entitiesRepo.upsertEntities(payload);
                ...
                addEventListener("item:".concat(previewMode, ":destroy"), function (_ref7) {
                  ...
                  _this3.entitiesRepo.destroyEntities('item', ids);
                });
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            ids = _ref8.ids;
                            _context3.next = 3;
                            return _this3.client.uploads.all({
                              'filter[ids]': ids.join(',')
                            }, {
                              deserializeResponse: false,
                              allPages: _this3.pageSize
                ...
                addEventListener('upload:destroy', function (_ref10) {
                  ...
                  _this3.entitiesRepo.destroyEntities('upload', ids);
                });
                addEventListener('item_type:upsert', /*#__PURE__*/function () {
                  var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(_ref11) {
                    var ids, _iterator, _step, _this3$entitiesRepo2, id, payloads;
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          ...
                          case 4:
                            ...
                            id = _step.value;
                            _context4.next = 8;
                            return Promise.all([_this3.client.itemTypes.find(id, {}, {
                              deserializeResponse: false
                            }), _this3.client.items.all({
                              'filter[type]': id,
                              version: itemVersion
                          ...
                          case 8:
                            ...
                            (_this3$entitiesRepo2 = _this3.entitiesRepo).upsertEntities.apply(_this3$entitiesRepo2, _toConsumableArray(payloads));
                ...
                addEventListener('item_type:destroy', function (_ref13) {
                  ...
                  ids.forEach(function (id) {
                    _this3.entitiesRepo.destroyItemType(id);
                  });
                });
